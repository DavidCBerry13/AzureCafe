...
TextAnalyticsClient textAnalyticsClient = new TextAnalyticsClient(new Uri("https://msdocs-app-insights-dotnet-text-analytics.cognitiveservices.azure.com/"), new AzureKeyCredential(textAnalyticsKey));
